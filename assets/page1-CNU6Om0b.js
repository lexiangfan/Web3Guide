const l={sections:[{id:"section1",title:"新手入门指南",files:[{id:"file1",title:"什么是 Web3",content:`
            <h2>Web3 简介</h2>
          ...
          `,lastUpdated:"2023-10-01"},{id:"file2",title:"钱包基础知识",content:`
            <h2>什么是加密钱包</h2>
          ...
          `,lastUpdated:"2023-10-02"}]},{id:"section2",title:"常见操作",files:[{id:"file3",title:"如何发送加密货币",content:`
            <h2>发送加密货币步骤</h2>
            <ol>
              <li>打开您的加密钱包应用</li>
              <li>选择要发送的加密货币类型</li>
          ...
          `,lastUpdated:"2023-10-04"}]}]};export{l as default};
